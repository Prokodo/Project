          ...
          <header className="bg-blue-600 text-white shadow">
              <nav className="p-2 px-10">
                  <div className="flex items-center justify-between content-between">
                      <h1 className="text-2xl font-bold">Tenant manager</h1>
                      <img src="/logo.png" alt="Company Logo" className="w-12 h-12 ml-2 object-contain" />
                  </div>
              </nav>
          </header>
              ...
              <section id="introduction" className="py-20 bg-white">
                  <div className="container mx-auto px-4">
                      ...
                      <p className="text-lg text-gray-700 max-w-3xl mx-auto text-center">
                          TenantManager is designed to streamline your property management tasks, allowing you to focus
                          on what matters most – providing excellent service to your tenants and growing your business.
                          Navigate through our application to manage tenants, properties, finances, and more with ease.
                      </p>
                  </div>
              </section>
                  ...
                  <div className="container mx-auto px-4">
                      ...
                      <div className="grid md:grid-cols-3 gap-8">
                          ...
                          <div
                              ...
                              <p className="text-gray-600">
                                  Monitor rent payments, expenses, and generate financial reports to keep your business
                                  finances in check.
                              </p>
                          </div>
